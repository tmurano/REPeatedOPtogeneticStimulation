...
# FC Context Distance
############################################
Data <- read_excel("FearConditioning_Data.xlsx", sheet = "4.Context_Dist_2")
...
ggsave("Context_d25_Distance.png", g, width = 6, height = 6, dpi = 300)
...
write.xlsx(
  ...
  file = "Context_d25_Distance_Stats.xlsx"
)

############################################
# FC Context Freezing
############################################
Data <- read_excel("FearConditioning_Data.xlsx", sheet = "4.Context_Freezing_2")
rownames(Data) <- rowname
Data <- Data[new_order, ]
Data <- Data[-c(18, 20), -1]  # remove dead mouse
...
ggsave("Context_d25_Freezing.png", g, width = 6, height = 6, dpi = 300)
...
write.xlsx(
  list(ANOVA_Result = anova, Bonf_Result1 = pwc1, Bonf_Result2 = pwc2),
  file = "Context_d25_Freezing_Stats.xlsx"
)
