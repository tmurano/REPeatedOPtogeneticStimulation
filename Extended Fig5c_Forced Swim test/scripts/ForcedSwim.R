...
############################################
Data <- read_excel("ForcedSwim_Data.xlsx", sheet = "PS1st")
...
ggsave("ForcedSwim.png", g, width = 6, height = 6, dpi = 300)
...
write.xlsx(
  ...
  file = "ForcedSwim_Stats.xlsx"
)

############################################
# Boxplot for Group Averages
############################################
Data <- read_excel("ForcedSwim_Data.xlsx", sheet = "PS1st")
Data <- Data[, -c(1, 19)]  # Remove dead mouse
...
ggsave("ForcedSwim_ave.png", g, width = 3.5, height = 5, dpi = 300)
...
write.xlsx(
  ...
  file = "ForcedSwim_ave_Stats.xlsx"
)
